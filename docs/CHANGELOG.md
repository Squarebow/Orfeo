...
### Changed
- **"Harmony" is now "Auto, more detailed".** Same engine at a higher sensitivity — it pools every non-drum track (melody included) and surfaces faster changes and embellishing chords, for dense arrangements or when you want the full harmonic detail. **"Follow"** stays a manual scope to one instrument or group.
