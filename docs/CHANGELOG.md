...
- **Chord changes inside a bar were averaged away.** The old detector summarised roughly a bar at a time, so three quick chords in one bar collapsed to one. It now marks a change wherever the accompaniment actually moves, at any rate the music does.
